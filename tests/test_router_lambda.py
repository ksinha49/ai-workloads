...
def test_lambda_handler(monkeypatch):
    ...
    module = load_lambda("router_lambda", "services/llm-gateway/src/2_llm_router_lambda.py")
...
def test_lambda_handler_backend_override(monkeypatch):
    ...
    calls = []
    monkeypatch.setattr(sys.modules["boto3"], "client", lambda name: _make_fake_send(calls))
    module = load_lambda("router_lambda_override", "services/llm-gateway/src/2_llm_router_lambda.py")
    module.sqs_client = sys.modules["boto3"].client("sqs")
...
def test_lambda_handler_strategy(monkeypatch):
    ...
    calls = []
    monkeypatch.setattr(sys.modules["boto3"], "client", lambda name: _make_fake_send(calls))
    module = load_lambda("router_lambda_strategy", "services/llm-gateway/src/2_llm_router_lambda.py")
    module.sqs_client = sys.modules["boto3"].client("sqs")
...
def test_lambda_handler_invoke_error(monkeypatch):
    ...
    module = load_lambda("router_lambda_error", "services/llm-gateway/src/2_llm_router_lambda.py")
    module.sqs_client = sys.modules["boto3"].client("sqs")
...
def test_lambda_handler_malicious_prompt(monkeypatch):
    ...
    calls = []
    monkeypatch.setattr(sys.modules["boto3"], "client", lambda name: _make_fake_send(calls))
    module = load_lambda("router_lambda_malicious", "services/llm-gateway/src/2_llm_router_lambda.py")
    module.sqs_client = sys.modules["boto3"].client("sqs")
...
def test_lambda_handler_bad_prompt_type(monkeypatch):
    ...
    calls = []
    monkeypatch.setattr(sys.modules["boto3"], "client", lambda name: _make_fake_send(calls))
    module = load_lambda("router_lambda_bad", "services/llm-gateway/src/2_llm_router_lambda.py")
    module.sqs_client = sys.modules["boto3"].client("sqs")
